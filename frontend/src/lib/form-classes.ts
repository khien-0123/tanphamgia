...
export const docDownloadBtnClass =
  'flex items-center gap-4 w-full p-4 px-5 border-0 rounded-lg bg-surface-fresh text-left cursor-pointer transition-colors duration-200 hover:bg-surface-muted';
